...
namespace VTC.Core
{
    public class ConstructorPrototypeDeclaration : Declaration
    {
        ...
        [Rule(@" <Constructor Proto> ::= <Mod> Id ~'(' <Types> ~')'  ~';'")]
        public ConstructorPrototypeDeclaration(Modifier m, Identifier id, TypeIdentifierListDefinition tdl)
        {
            _name = id;
            _tdl = tdl;
            mod = m;
        }
        [Rule(@"<Constructor Proto> ::= <Mod> Id ~'(' <Params> ~')' ~';'")]
        public ConstructorPrototypeDeclaration(Modifier m, Identifier id, ParameterListDefinition pal)
        {
            _name = id;
            _pal = pal;
            mod = m;
        }
        [Rule(@"<Constructor Proto> ::= <Mod> Id ~'(' ~')' ~';'")]
        public ConstructorPrototypeDeclaration(Modifier m,Identifier id)
        {
            _name = id;
            _pal = null;
            mod = m;
 ...
 public override SimpleToken DoResolve(ResolveContext rc)
        {
           ...
           mods |= Modifiers.Prototype;
            ...
            method = new MethodSpec(rc.CurrentNamespace, _name.Name+"_$ctor", mods | Modifiers.Prototype,BuiltinTypeSpec.Void, ccv, null, this.Location);
            ...
            method = new MethodSpec(rc.CurrentNamespace, _name.Name+"_$ctor", mods | Modifiers.Prototype,BuiltinTypeSpec.Void, ccv, tp.ToArray(), this.Location);
